...
echo -e "[${GREEN}INFO${NC}] Creating global commands..."
ln -sf "$INSTALL_DIR/vps-manager.sh" /usr/local/bin/vpsshieldpro
ln -sf "$INSTALL_DIR/vps-manager.sh" /usr/local/bin/admin
ln -sf "$INSTALL_DIR/vps-manager.sh" /usr/local/bin/vps
...
echo -e "║                                                            ║"
echo -e "║  ${YELLOW}Run the script with any of these commands:${NC}               ║"
